	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			...
			'lideresgestion' => "`lideresgestion`.`LLAVE` as 'LLAVE', `lideresgestion`.`CODGESTION` as 'CODGESTION', `lideresgestion`.`CEDULA` as 'CEDULA', `lideresgestion`.`CELULAR` as 'CELULAR', `lideresgestion`.`OBSERVACIONES` as 'OBSERVACIONES', `lideresgestion`.`ESTADO` as 'ESTADO'",
