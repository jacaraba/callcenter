	...
	if($thisMD5 != $prevMD5) {
		...
		setupTable(
			...
			CREATE TABLE IF NOT EXISTS `gestion` ( 
				...
				`DESGESTION` VARCHAR(40) NULL
			) CHARSET utf8mb4", [
				" ALTER TABLE `gestion` CHANGE `CODGESTION` `CODGESTION` VARCHAR(40) NOT NULL ",
				" ALTER TABLE `gestion` CHANGE `CODGESTION` `CODGESTION` VARCHAR(4) NOT NULL ",
				" ALTER TABLE `gestion` CHANGE `DESGESTION` `DESGESTION` VARCHAR(40) NULL ",
			]
		);
