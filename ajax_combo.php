	...
	$lookups = [
		...
		'lideresgestion' => [
			...
			'CELULAR' => [
				'parent_table' => 'lideres',
				'parent_pk_field' => 'CEDULA',
				'parent_caption' => 'IF(CHAR_LENGTH(`lideres`.`CELULAR`) || CHAR_LENGTH(`lideres`.`NOMBRE`), CONCAT_WS(\'\', `lideres`.`CELULAR`, \' - \', `lideres`.`NOMBRE`), \'\')',
				'parent_from' => '`lideres` LEFT JOIN `divpol2022` as divpol20221 ON `divpol20221`.`PUESTO`=`lideres`.`PUESTO` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
		...
		'amigos' => [
			...
			'PUESTO' => [
				...
				'parent_from' => '`divpol2022` ',
				'filterers' => [],
				'custom_query' => 'SELECT `divpol2022`.`PUESTO`, IF(CHAR_LENGTH(`divpol2022`.`PUESTO`) || CHAR_LENGTH(`divpol2022`.`nompue`), CONCAT_WS(\'\', `divpol2022`.`PUESTO`, \' - \', `divpol2022`.`nompue`), \'\') FROM `divpol2022` ORDER BY 2',
				'inherit_permissions' => false,
				'list_type' => 0,
				'not_null' => false,
			],
