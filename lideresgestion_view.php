...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->ColCaption = ['LLAVE', 'CODGESTION', 'CEDULA', 'CELULAR', 'OBSERVACIONES', 'ESTADO', ];
	$x->ColFieldName = ['LLAVE', 'CODGESTION', 'CEDULA', 'CELULAR', 'OBSERVACIONES', 'ESTADO', ];
